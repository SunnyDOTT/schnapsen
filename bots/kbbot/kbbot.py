...
class Bot:
    ...
    def get_move(self, state):
        ...
        for move in moves:
            if self.play_trump_wedding(state, move):
                return move

        for move in moves:
            if self.play_cheap_cards(state, move):
    ...
    def play_trump_wedding(self, state, move):
        kb = KB()

        load.trump_wedding_info(kb)

        load.trump_wedding_strat(kb)
